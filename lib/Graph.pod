...
alternative results are wanted.  To do this, the following methods are
available:
...
weakly_connected_component_by_index(), same_weakly_connected_components(),
...
Note that any such computed and cached results are of course discarded
if the graph is modified.
