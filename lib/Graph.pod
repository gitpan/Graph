...
original, and if the original was a C<compat02> graph, the copy will be, too.
...
See also L</all_neighbours> and L</all_reachable>.
...
Return the neighbo(u)ring vertices of the argument vertices,
...
reachable from the argument vertices.

See also L</neighbours> and L</all_reachable>.
...
For an undirected graph, equivalent to C<all_neighbours>.

See also L</neighbours>, L</all_neighbours>, and L</all_successors>.
...
It is described in:
    ...
    Freeman, A set of measures of centrality based on betweenness, http://links.jstor.org/sici?sici=0038-0431(197703)40%3A1%3C35%3AASOMOC%3E2.0.CO%3B2-H
...
Returns the clustering coefficient gamma as described in
    ...
    Duncan J. Watts and Steven Strogatz, Collective dynamics of 'small-world' networks, http://tam.cornell.edu/SS_nature_smallworld.pdf
